...
// 其他模組要查詢商家營業時間/服務人員可預約時段/當日行事曆/預約清單,或要建立/取消/完成預約,
// 一律 import 這個檔案匯出的 hooks/函式,不要自己 import supabase client 直接查
// merchant_business_hours/staff_availability_windows/bookings 這三張表(規格書第五節)。
...
/** 5.4 對外介面:依 id 查單筆預約詳情。 */
export { getBooking };

/** 5.5 對外介面:建立/取消/完成預約,包一層呼叫 3.3/3.4/3.5,供未來任何需要建立/取消/完成預約的
 * 模組(模組 6、模組 13)呼叫,不需要重新實作規則 2.1~2.6、2.9 的驗證與狀態機邏輯。 */
