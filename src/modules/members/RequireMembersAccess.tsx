// 模組 10(會員與紅利)§4.6:會員管理列表頁(4.1)/會員詳情頁(4.2)的路由守衛。完全比照
// RequireTeamLeaveAccess.tsx 的既有寫法。判斷邏輯:merchantRole === 'admin' 一律放行;
// merchantRole === 'agent' 則要求 useAgentPermission('members') 回傳 true 才放行。
...
export function RequireMembersAccess({ children }: { children: ReactNode }) {
