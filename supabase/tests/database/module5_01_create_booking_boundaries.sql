...
select lives_ok(
  $$select create_booking(
    ...
    'b1000000-0000-4000-8000-000000000030', '2026-09-22 10:00:00+08',
    '客戶一', '0911000001'
  )$$,
...
select throws_ok(
  $$select create_booking(
    'b1000000-0000-4000-8000-000000000020', 'b1000000-0000-4000-8000-000000000040',
    'b1000000-0000-4000-8000-000000000030', '2026-09-22 11:00:00+08',
    '客戶二', '0911000002'
  )$$,
  'P0001', null,
...
select throws_ok(
  $$select create_booking(
    'b1000000-0000-4000-8000-000000000020', 'b1000000-0000-4000-8000-000000000040',
    'b1000000-0000-4000-8000-000000000030', '2026-09-22 08:00:00+08',
    '客戶三', '0911000003'
  )$$,
  'P0001', null,
  '規則 2.1:早於商家營業時間,被擋下'
...
select throws_ok(
  $$select create_booking(
    'b1000000-0000-4000-8000-000000000020', 'b1000000-0000-4000-8000-000000000040',
    'b1000000-0000-4000-8000-000000000030', '2026-09-23 10:00:00+08',
    '客戶四', '0911000004'
  )$$,
  'P0001', null,
  '規則 2.1:當天公休,被擋下'
...
select throws_ok(
  $$select create_booking(
    'b1000000-0000-4000-8000-000000000020', 'b1000000-0000-4000-8000-000000000040',
    'b1000000-0000-4000-8000-000000000030', '2026-09-24 10:00:00+08',
    '客戶五', '0911000005'
  )$$,
  'P0001', null,
