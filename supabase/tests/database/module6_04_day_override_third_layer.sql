...
insert into payment_methods (id, merchant_id, name) values ('59b3d7ce-18b5-5f44-a02d-125d743c9eea', 'c4000000-0000-4000-8000-000000000020', '現場付款');
...
select ok(
  pg_temp.capture_error($$select create_booking(
    ...
    jsonb_build_array(jsonb_build_object('service_item_id','c4000000-0000-4000-8000-000000000031','quantity',1,'unit_price',100)), '2026-09-22 10:00:00+08',
    'B4客戶重試', '0921000106'
  , p_payment_method_id => '59b3d7ce-18b5-5f44-a02d-125d743c9eea')$$) like '%10:30%11:00%',
