...
select throws_ok(
  $$select create_booking(
    ...
    array['b7000000-0000-4000-8000-000000000031']::uuid[], '2026-09-22 10:00:00+08',
...
select lives_ok(
  $$select create_booking(
    'b7000000-0000-4000-8000-000000000021', 'b7000000-0000-4000-8000-000000000041',
    array['b7000000-0000-4000-8000-000000000031']::uuid[], '2026-09-22 14:00:00+08',
...
select throws_ok(
  $$select create_booking(
    ...
    array['b7000000-0000-4000-8000-000000000031']::uuid[], '2026-09-22 14:30:00+08',
    '客戶五', '0911100005'
  )$$,
  'P0001', null,
...
select lives_ok(
  $$select create_booking(
    ...
    array['b7000000-0000-4000-8000-000000000032']::uuid[], '2026-09-22 10:00:00+08',
    '二店客戶', '0922000000'
  )$$,
...
select throws_ok(
  $$select create_booking(
    'b7000000-0000-4000-8000-000000000021', 'b7000000-0000-4000-8000-000000000041',
    array['b7000000-0000-4000-8000-000000000031']::uuid[], '2026-09-22 10:30:00+08',
...
select lives_ok(
  $$select create_booking(
    'b7000000-0000-4000-8000-000000000021', 'b7000000-0000-4000-8000-000000000041',
    array['b7000000-0000-4000-8000-000000000031']::uuid[], '2026-09-22 15:00:00+08',
...
select throws_ok(
  format(
    $$select create_booking(
      'b7000000-0000-4000-8000-000000000021', 'b7000000-0000-4000-8000-000000000041',
      array['b7000000-0000-4000-8000-000000000031']::uuid[], '2026-09-22 16:00:00+08',
