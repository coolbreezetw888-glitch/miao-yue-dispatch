...
insert into payment_methods (id, merchant_id, name) values ('e4e37838-0163-5c42-881d-0290b019b667', 'c5000000-0000-4000-8000-000000000020', '現場付款');
...
select throws_ok(
  $$select create_booking(
    ...
    '交界測試客戶', '0921000201'
  , p_payment_method_id => 'e4e37838-0163-5c42-881d-0290b019b667')$$,
  'P0001', null,
