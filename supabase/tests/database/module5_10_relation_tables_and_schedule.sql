...
insert into merchant_staff (id, merchant_id, name, phone, no_time_slot_limit) values
  ('ba000000-0000-4000-8000-000000000041', 'ba000000-0000-4000-8000-000000000021', '主要人員', '0901000101', true),
  ('ba000000-0000-4000-8000-000000000042', 'ba000000-0000-4000-8000-000000000021', '助手E', '0955333333', true);

-- 二店的師傅F,電話字串跟一店助手E完全相同,用來驗證「以助手身份跨商家占用」也會出現在
-- foreign_bookings(4.2 第 3 點)。2026-09-22 補充:merchant_staff.phone 改成 NOT NULL +
-- CHECK(phone ~ '^09\d{8}$')之後,不能再用帶符號格式表示同一號碼,兩邊改成逐字相同。
