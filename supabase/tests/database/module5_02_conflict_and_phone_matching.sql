...
select lives_ok(
  $$select create_booking(
    ...
    array['b2000000-0000-4000-8000-000000000031']::uuid[], '2026-09-22 10:00:00+08',
    '一店客戶', '0933000001'
  )$$,
...
select throws_ok(
  $$select create_booking(
    ...
    array['b2000000-0000-4000-8000-000000000032']::uuid[], '2026-09-22 10:30:00+08',
    '二店客戶', '0933000002'
  )$$,
  'P0001', null,
...
select lives_ok(
  $$select create_booking(
    'b2000000-0000-4000-8000-000000000022', 'b2000000-0000-4000-8000-000000000042',
    array['b2000000-0000-4000-8000-000000000032']::uuid[], '2026-09-22 14:00:00+08',
    '二店客戶2', '0933000003'
  )$$,
  '規則 2.6:不重疊的時段,建立成功'
);
...
select lives_ok(
  $$select create_booking(
    ...
    array['b2000000-0000-4000-8000-000000000031']::uuid[], '2026-09-22 14:00:00+08',
    '一店客戶D', '0933000005'
  )$$,
