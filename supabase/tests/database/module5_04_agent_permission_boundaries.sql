...
select throws_ok(
  $$select create_booking(
    ...
    'b4000000-0000-4000-8000-000000000030', '2026-09-22 10:00:00+08',
    '客戶', '0966000001'
  )$$,
  '42501', null,
...
select is(:'orders_agent_status'::text, 'accepted'::text, '規則 2.12:被授權 orders 的客服可以成功呼叫 create_booking');
